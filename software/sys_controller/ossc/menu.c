...
MENU(menu_advtiming, P99_PROTECT({ \
    ...
    { LNG("H. synclen","H. ﾗｲﾝﾄﾞｳｷｼﾝｺﾞｳ"),       OPT_AVCONFIG_NUMVAL_U16,{ .num_u16 = { &tc_h_synclen,    H_SYNCLEN_MIN, H_SYNCLEN_MAX, vm_tweak } } },
    ...
    { LNG("V. synclen","V. ﾗｲﾝﾄﾞｳｷｼﾝｺﾞｳ"),       OPT_AVCONFIG_NUMVAL_U16,{ .num_u16 = { &tc_v_synclen,    V_SYNCLEN_MIN, V_SYNCLEN_MAX, vm_tweak } } },
