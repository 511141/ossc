...
MENU(menu_output, P99_PROTECT({ \
    ...
    { LNG("480i/576i proc","384pｼｮﾘ"),          OPT_AVCONFIG_SELECTION, { .sel = { &tc.pm_480i,         OPT_WRAP, SETTING_ITEM(pm_480i_desc) } } },
    { LNG("480p/576p proc","384pｼｮﾘ"),          OPT_AVCONFIG_SELECTION, { .sel = { &tc.pm_480p,         OPT_WRAP, SETTING_ITEM(pm_384p_480p_desc) } } },
    { LNG("960i/1080i proc","384pｼｮﾘ"),         OPT_AVCONFIG_SELECTION, { .sel = { &tc.pm_1080i,        OPT_WRAP, SETTING_ITEM(pm_480i_desc) } } },
    ...
    { LNG("256x240 aspect","384pｱｽﾍﾟｸﾄ"),       OPT_AVCONFIG_SELECTION, { .sel = { &tc.ar_256col,       OPT_WRAP, SETTING_ITEM(ar_256col_desc) } } },
...
MENU(menu_main, P99_PROTECT({ \
    ...
    AUDIO_MENU
    { LNG("<Load profile >"),(ﾛｰﾄﾞ                       OPT_SUBMENU,            { .sub = { NULL, load_profile_disp } } },
